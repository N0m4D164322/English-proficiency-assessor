...
void initializeTopics(Topic *topics) {
    ...
    clearScreen();
    topics[0] = (Topic) {
        .explanation = "This Program was created by Atif Ahnaf Chowdhury. \nFor Nayon sir,\n"
        ...
        .problems = {
            ...
            "3. Because I was tired. (fragment)",
            "4. I like to read I also enjoy writing. (run-on)",
            "5. She likes running, to swim, and biking. (parallel structure)\n\n",
        },
        .answers = {"compound", "complex", "fragment", "run-on", "incorrect"},
        .numProblems = 5,
